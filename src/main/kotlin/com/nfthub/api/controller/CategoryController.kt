...
//
//    @Operation(summary = " 카테고리 생성 ", description = "어드민 전용")
//    @ApiResponses(
//        ApiResponse(responseCode = "200", description = "정상응답"),
...
//
//    @Operation(summary = " 카테고리 수정 ", description = "어드민 전용")
//    @ApiResponses(
//        ApiResponse(responseCode = "200", description = "정상응답"),
//        ApiResponse(responseCode = "401", description = "인증 필요"),
//        ApiResponse(responseCode = "403", description = "권한 없음"),
...
//
//    @Operation(summary = " 카테고리 제거 ", description = "어드민 전용")
//    @ApiResponses(
...
//) {
//    @Operation(summary = "카테고리 그룹 이름 및 속해있는 카테고리 조회 ")
//    @ApiResponses(
//        ApiResponse(responseCode = "200", description = "정상응답"),
//        ApiResponse(responseCode = "404", description = "찾을 수 없음"),
//    )
...
//
//    @Operation(summary = " 카테고리 그룹 이름 생성 ", description = "어드민 전용")
//    @ApiResponses(
//        ApiResponse(responseCode = "200", description = "정상응답"),
//        ApiResponse(responseCode = "401", description = "인증 필요"),
//        ApiResponse(responseCode = "403", description = "권한 없음"),
...
//
//    @Operation(summary = " 카테고리 그룹 이름 수정 ", description = "어드민 전용")
//    @ApiResponses(
//        ApiResponse(responseCode = "200", description = "정상응답"),
//        ApiResponse(responseCode = "401", description = "인증 필요"),
//        ApiResponse(responseCode = "403", description = "권한 없음"),
...
//
//    @Operation(summary = " 카테고리 그룹에 카테고리 할당 ", description = "어드민 전용")
//    @ApiResponses(
//        ApiResponse(responseCode = "200", description = "정상응답"),
//        ApiResponse(responseCode = "401", description = "인증 필요"),
//        ApiResponse(responseCode = "403", description = "권한 없음"),
